...
public class Parameter {
    ...
    public static final String BILL_ORDER_ID = "orderId";
    public static final String BILL_ROOM_ID = "roomId";
    public static final String BILL_PAYMENT_AMOUNT = "paymenAmount";
    ...
    public static final String ORDER_ROOM_TYPE_ID = "roomTypeId";
    ...
    public static final String ROOM_HOTEL_ID = "hotelId";
    public static final String ROOM_ROOM_TYPE_ID = "roomTypeId";
    public static final String ROOM_NUMBER = "roomNumber";
    public static final String ROOM_BOOKED_UP_TO = "bookedUpTo";
    ...
    public static final String ROOM_AVAILABLE_ROOMS = "availableRooms";
    public static final String ROOM_HOTEL_ROOMS = "hotelRooms";
